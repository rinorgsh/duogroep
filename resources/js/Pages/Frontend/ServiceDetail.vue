                        ...
                        <div class="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl md:rounded-3xl p-6 md:p-8 text-white shadow-xl">
                            ...
                            <div class="mt-5 md:mt-6 space-y-3">
                                <div class="text-center">
                                    ...
                                    <a href="tel:+32477020780" class="text-white hover:text-primary-100 transition-colors font-bold text-lg md:text-xl">
                                        0477 02 07 80
                                    </a>
                                </div>
                                <div class="text-center">
                                    <p class="text-primary-200 text-xs md:text-sm mb-1">{{ t('sd_or_email') }}</p>
                                    <a href="mailto:info@duogroepclean.be" class="text-white hover:text-primary-100 transition-colors font-bold text-sm md:text-base">

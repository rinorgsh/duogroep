    ...
    <div class="min-h-screen bg-white">
        ...
        <header class="bg-primary-900 shadow-sm py-4">
            <div class="max-w-5xl mx-auto px-4 flex justify-between items-center">
                ...
                <a href="tel:+32470726137" class="bg-white text-primary-900 hover:bg-primary-50 font-bold px-6 py-3 rounded-xl text-sm inline-flex items-center transition-colors">

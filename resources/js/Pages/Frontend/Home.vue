                ...
                <div class="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-3 text-white">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 md:gap-4 mb-8 md:mb-12">
                            ...
                            <a href="tel:+32477020780" class="group inline-flex items-center justify-center px-7 py-4 md:px-10 md:py-5 bg-white/10 backdrop-blur-md text-white text-base md:text-lg font-bold rounded-2xl border border-white/20 active:bg-white/20 md:hover:bg-white/20 transition-all duration-300">
                                <svg class="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section class="relative py-14 md:py-24 overflow-hidden">
            ...
            <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-3 md:gap-5 justify-center">
                    ...
                    <a href="tel:+32477020780" class="inline-flex items-center justify-center px-8 py-4 md:px-12 md:py-6 border-2 border-white/30 text-white text-base md:text-xl font-bold rounded-2xl active:bg-white/20 md:hover:bg-white/10 backdrop-blur-sm transition-all duration-300">
                        <svg class="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                        </svg>
                        {{ t('hero_cta_call') }}
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="order-1 lg:order-2">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="tel:+32477020780" class="btn-secondary">
